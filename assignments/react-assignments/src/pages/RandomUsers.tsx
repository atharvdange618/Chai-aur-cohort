  ...
  return (
    <div className="min-h-screen p-8">
      ...
      <header className="mb-8 text-center">
        ...
        <p className="text-[#6b6b6b] mt-1">Browse user profiles from around the world</p>
      </header>
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#6b6b6b] text-sm capitalize">{user.gender}</p>
                  </div>
                </div>
                <div className="space-y-2 text-sm">
                  <p className="text-[#6b6b6b]">
                    <span className="text-[#2d2d2d]">📍</span> {user.location.city}, {user.location.country}
                  </p>
                  <p className="text-[#6b6b6b]">
                    <span className="text-[#2d2d2d]">📧</span> {user.email}
                  </p>
                  <p className="text-[#6b6b6b]">
                    <span className="text-[#2d2d2d]">🎂</span> {user.dob.age} years old
                  </p>
                </div>
      ...
      {selectedUser && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setSelectedUser(null)}>
          <div className="bg-[#faf8f5] border-2 border-[#2d2d2d] rounded-xl max-w-lg w-full" onClick={(e) => e.stopPropagation()}>
            <div className="p-6">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#6b6b6b] capitalize">{selectedUser.gender}</p>
                  </div>
                </div>
                <button
              ...
              <div className="space-y-4">
                <div className="bg-[#e8d5c4] rounded-lg p-4">
                  <h3 className="text-sm font-medium text-[#6b6b6b] mb-2">Location</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-[#e8d5c4] rounded-lg p-4">
                    <h3 className="text-sm font-medium text-[#6b6b6b] mb-1">Email</h3>
                    <p className="text-[#2d2d2d] text-sm">{selectedUser.email}</p>
                  </div>
                  <div className="bg-[#e8d5c4] rounded-lg p-4">
                    <h3 className="text-sm font-medium text-[#6b6b6b] mb-1">Phone</h3>
                    <p className="text-[#2d2d2d] text-sm">{selectedUser.phone}</p>
                  </div>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-[#e8d5c4] rounded-lg p-4">
                    <h3 className="text-sm font-medium text-[#6b6b6b] mb-1">Age</h3>
                    <p className="text-[#2d2d2d]">{selectedUser.dob.age} years</p>
                  </div>
                  <div className="bg-[#e8d5c4] rounded-lg p-4">
                    <h3 className="text-sm font-medium text-[#6b6b6b] mb-1">Nationality</h3>
                    <p className="text-[#2d2d2d]">{selectedUser.nat}</p>
                  </div>
                </div>

                <div className="bg-[#e8d5c4] rounded-lg p-4">
                  <h3 className="text-sm font-medium text-[#6b6b6b] mb-1">Timezone</h3>
